...
This file is the source of truth for agent guidance in this repo. `AGENTS.md` must mirror this file and stay in sync. If you update this file, update `AGENTS.md` with the same changes to maintain compatibility with tools that only read one of them.

This file provides guidance to any agentic coding assistant that recognizes `AGENTS.md` as its repository instruction standard.
